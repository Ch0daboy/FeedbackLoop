    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">AI-Powered Feedback Implementation</p>
        </div>
          ...
          <div className="mt-6">
            ...
            <div className="mt-6">
              <p className="text-sm text-gray-600 text-center">
                ...
                <Link href="/feedback?projectId=demo" className="font-medium text-blue-600 hover:text-blue-500">
                  submit feedback without signing in
                </Link>
              </p>
            </div>
          </div>
